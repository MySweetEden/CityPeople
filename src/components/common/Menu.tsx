...
const Menu = () => {
  ...
  return (
    <div className="bg-white w-full fixed top-0 h-16 items-center z-10">
      <div className="flex flex-start border-b border-gray-900">
        <div className="flex h-full">
          ...
          <Link
            to="/detail"
            className={`${
              path == "/detail" ? "selectBtn" : "button"
            } py-2 inline-flex items-center justify-center text-center w-52 border-r border-gray-900`}
          >
